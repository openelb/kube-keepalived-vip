...
The chart supports both the normal mode of operation and the mode with PROXY protocol support via HAProxy.  It has been tested on Kubernetes 1.21 and 1.23.
